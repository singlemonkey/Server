...
var _topbar = _interopRequireDefault(__webpack_require__(27));

var _sidebar = _interopRequireDefault(__webpack_require__(28));
...
_reactDom.default.render(_react.default.createElement(_topbar.default, {
  list: topbarList
...
function (_Component) {
  ...
  function Entrance(props) {
    ...
    return _possibleConstructorReturn(this, (Entrance.__proto__ || Object.getPrototypeOf(Entrance)).call(this, props));
  }
  ...
  _createClass(Entrance, [{
    ...
    value: function render() {
      return _react.default.createElement("a", {
        className: "topbar-user-entrance",
        href: this.props.info.url
      }, _react.default.createElement("i", {
        className: "iconfont ".concat(this.props.info.icon)
      }), _react.default.createElement("span", null, this.props.info.name));
    }
  }]);

  return Entrance;
}(_react.Component); //用户工具构造


var Userbar =
/*#__PURE__*/
function (_Component2) {
  _inherits(Userbar, _Component2);
  ...
  _createClass(Userbar, [{
    key: "render",
    value: function render() {
      var entrances = this.props.userControl.entrances.map(function (entrance) {
        return _react.default.createElement(Entrance, {
          key: entrance.name,
          info: entrance
        });
      });
      return _react.default.createElement("div", {
        ...
        alt: "\u672C\u5C0A",
        className: "nav-user-avator",
        src: this.props.userControl.avatorUrl
      })), _react.default.createElement("div", {
        className: "nav-dropdown-menu nav-user"
      }, _react.default.createElement("div", {
        className: "nav-user-info"
      }, _react.default.createElement("p", {
        className: "nav-user-name"
      }, _react.default.createElement("span", null, this.props.userControl.userName)), _react.default.createElement("p", {
        className: "nav-user-mood"
      }, _react.default.createElement("span", null, this.props.userControl.userMood))), _react.default.createElement("div", {
        className: "nav-user-contorl"
      }, entrances)));
    }
  }]);

  return Userbar;
}(_react.Component); //总体的topbar构造


var Topbar =
/*#__PURE__*/
function (_Component3) {
  _inherits(Topbar, _Component3);
  ...
  _createClass(Topbar, [{
    key: "render",
    value: function render() {
      return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(Userbar, {
        userControl: this.props.list.UserControl
      }));
    }
  }]);
